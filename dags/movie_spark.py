...
with DAG(
    ...
    SCRIPT_BASE="/home/gmlwls5168/code/myairflow/pyspark"
    META_PATH="/home/gmlwls5168/data/movie_spark/meta"
    RAW_BASE="/home/gmlwls5168/data/movie_after/dailyboxoffice"
    ...
    append_meta = BashOperator(
        ...
        bash_command="""
            ...
            $SCRIPT_BASE/movie_meta.py \
            $RAW_BASE/dt={{ ds_nodash }} append \
            $META_PATH
            """,
        env={
